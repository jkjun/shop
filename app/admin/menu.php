...
Admin::menu()->url('/')->label('Стартовая страница')->icon('fa-heart')->uses('\SleepingOwl\Admin\Controllers\DummyController@getIndex');
Admin::menu()->url('/')->label('Стартовая страница2')->icon('fa-university')->uses('\SleepingOwl\Admin\Controllers\DummyController@getIndex');
